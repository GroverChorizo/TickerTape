...
if not TOKEN:
    ...
    sys.exit(2)
headers = {'Accept': 'application/vnd.github+json', 'User-Agent': 'TickerTape-Agent', 'Authorization': 'Bearer ' + TOKEN}
req = urllib.request.Request('https://api.github.com/repos/GroverChorizo/TickerTape/pulls',
